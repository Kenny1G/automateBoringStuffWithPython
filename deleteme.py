...
BUTTONGAPSIZE = 20
TIMEOUT = 4
BEEP1PATH = 'C:/PythonScripts/Games/pygameBasics/makingGamesZip/beep1.ogg'
BEEP2PATH = 'C:/PythonScripts/Games/pygameBasics/makingGamesZip/beep2.ogg'
BEEP3PATH = 'C:/PythonScripts/Games/pygameBasics/makingGamesZip/beep2.ogg'
BEEP4PATH = 'C:/PythonScripts/Games/pygameBasics/makingGamesZip/beep4.ogg'
#                R    G    B
...
or using the Q, W, A, S keys.', 1, DARKGRAY)
    ...
    while True: #main game loop
        ...
        if not waitingForInput:
            ...
            if clickedButton and clickedButton == ColorPattern[NextColorToPush]:
                flashButtonAnimation(clickedButton)
                NextColorToPush += 1
                lastClickTime = time.time()

                if NextColorToPush == len(ColorPattern):
                    changeBackgroundAnimation()
                    score += 1
                    waitingForInput = False
                    NextColorToPush = 0
            elif (clickedButton and clickedButton != ColorPattern[NextColorToPush]) or (NextColorToPush != 0 and time.time() - TIMEOUT > lastClickTime):
                gameOverAnimation()
                ColorPattern = []
                NextColorToPush = 0
                waitingForInput = False
